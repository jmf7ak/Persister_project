...
model.add_boundary(model.metabolites.get_by_id("cpd00002_c"), type="demand")
model.objective='DM_cpd00002_c'
model.solver='gurobi'
...
dir= r"/scratch/jmf7ak/persister/outputs/ATP_open/"
name=os.path.splitext(os.path.basename(counts_file))[0]
outFile= 'riptide_results_ATP/' + name
current = dir + outFile
