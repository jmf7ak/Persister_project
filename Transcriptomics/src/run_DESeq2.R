...
assay(vsd_group) <- removeBatchEffect(
  assay(vsd_group),
  batch = coldata$batch
)

pca_plot = plotPCA(vsd_group, intgroup = c("condition","time"))
ggsave(
  filename = "C:/Users/jmf7ak/OneDrive - University of Virginia/25_SPRING/PERSISTER/2025_SUBMISSION/PCA_variance.png",
  plot = pca_plot,
  width = 6,
  height = 5
)
