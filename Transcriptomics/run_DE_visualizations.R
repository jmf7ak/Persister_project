...
#write.csv(T5T0_sig_up,file.path(dir, 'analysis', 'DESeq2', 'T5T0_upregulated.csv'))
#write.csv(T5T0_sig_down,file.path(dir, 'analysis', 'DESeq2', 'T5T0_downregulated.csv'))
#write.csv(U5U0_sig_up,file.path(dir, 'analysis', 'DESeq2', 'U5U0_upregulated.csv'))
#write.csv(U5U0_sig_down,file.path(dir, 'analysis', 'DESeq2', 'U5U0_downregulated.csv'))
#write.csv(T24T0_sig_up,file.path(dir, 'analysis', 'DESeq2', 'T24T0_upregulated.csv'))
#write.csv(T24T0_sig_down,file.path(dir, 'analysis', 'DESeq2', 'T24T0_downregulated.csv'))
#write.csv(U24U0_sig_up,file.path(dir, 'analysis', 'DESeq2', 'U24U0_upregulated.csv'))
#write.csv(U24U0_sig_down,file.path(dir, 'analysis', 'DESeq2', 'U24U0_downregulated.csv'))

#### visualize overlap ####

upregulated <- list(P5vsP0 = T5T0_sig_up$X, P24vsP0 = T24T0_sig_up$X, U5vsU0 = U5U0_sig_up$X, U24vsU0 = U24U0_sig_up$X)
downregulated <- list(P5vsP0 = T5T0_sig_down$X, P24vsP0 = T24T0_sig_down$X, U5vsU0 = U5U0_sig_down$X, U24vsU0 = U24U0_sig_down$X)

upset(fromList(upregulated),
      sets = rev(c('P5vsP0','P24vsP0','U5vsU0','U24vsU0')),
      order.by = "freq",
...
colnames(heatmap_sig_groupbatch_v0) <- c('P5 vs. P0','U5 vs. U0','P24 vs. P0','U24 vs. U0')
...
enrich_U5U0_up <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_U5U0_upregulated-bh.csv'), header = TRUE)
enrich_U5U0_down <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_U5U0_downregulated-bh.csv'), header = TRUE)
enrich_U24U0_up <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_U24U0_upregulated-bh.csv'), header = TRUE)
enrich_U24U0_down <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_U24U0_downregulated-bh.csv'), header = TRUE)
enrich_T5T0_up <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_T5T0_upregulated-bh.csv'), header = TRUE)
enrich_T5T0_down <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_T5T0_downregulated-bh.csv'), header = TRUE)
enrich_T24T0_up <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_T24T0_upregulated-bh.csv'), header = TRUE)
enrich_T24T0_down <- read.csv(file.path(dir, 'analysis', 'enrichment', 'enrich_T24T0_downregulated-bh.csv'), header = TRUE)
...
ggplot(enrich_table, aes(x = term)) +
  ...
  #geom_text(data = enrich_table_plot %>% filter(sign == "up"), aes(y = perc_set + 0.2, label = label), 
  #          size = 5) +
  #geom_text(data = enrich_table_plot %>% filter(sign == "down"), aes(y = perc_set - 0.2, label = label), 
  #          size = 5) +
  coord_flip() + 
  scale_fill_manual(values = c("U5U0" = myPalette[7],
                               ...
                               "T5T0" = myPalette[4],
                               "T24T0" = myPalette[5]),
                    labels = c("U5 vs. U0","U24 vs. U0","P5 vs. P0","P24 vs. P0"),
...
colnames(heatmap_metab_sig) <- c('P5 vs. P0','U5 vs. U0','P24 vs. P0','U24 vs. U0')
