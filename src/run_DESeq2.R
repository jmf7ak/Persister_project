...
files <- list.files(path = file.path(dir, 'analysis', 'counts'), pattern="*.counts")
...
for (i in 1:length(files)) assign(sampleName[i], read.table(file.path(dir, 'analysis', 'counts', files[i])))
...
write.csv(as.data.frame(T5T0batch),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_groupbatch_T5T0_results.csv"))
write.csv(as.data.frame(U5U0batch),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_groupbatch_U5U0_results.csv"))
write.csv(as.data.frame(T24T0batch),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_groupbatch_T24T0_results.csv"))
write.csv(as.data.frame(U24U0batch),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_groupbatch_U24U0_results.csv"))
write.csv(as.data.frame(T5U5batch),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_groupbatch_T5U5_results.csv"))
write.csv(as.data.frame(T24U24batch),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_groupbatch_T24U24_results.csv"))
...
write.csv(as.data.frame(TU5),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_timebatch_TU5_results.csv"))
write.csv(as.data.frame(TU24),file=file.path(dir, 'analysis', 'DESeq2', "DESeq_dds_timebatch_TU24_results.csv"))
