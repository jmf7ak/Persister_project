function [model_ess_pa14, model_ess_U5, model_ess_U24, model_ess_T5, model_ess_T24, common_ess, unique_treated, unique_untreated, unique_U5, unique_U24, unique_T5, unique_T24] = persisterEssentialityMin(pa14, U5, U24, T5, T24)
...
for i = 1:length(present_T24)
    ...
    T24_deleted_sol = optimizeCbModel(T24_deleted,'min');
...
for i = 1:length(present_T5)
    ...
    T5_deleted_sol = optimizeCbModel(T5_deleted,'min');
...
for i = 1:length(present_U24)
    ...
    U24_deleted_sol = optimizeCbModel(U24_deleted,'min');
...
for i = 1:length(present_U5)
    ...
    U5_deleted_sol = optimizeCbModel(U5_deleted,'min');
...
for i = 1:length(pa14.genes)
    ...
    pa14_deleted_sol = optimizeCbModel(pa14_deleted,'min');
